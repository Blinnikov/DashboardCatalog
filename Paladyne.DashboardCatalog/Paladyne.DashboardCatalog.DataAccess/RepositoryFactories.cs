...
using Paladyne.DashboardCatalog.DataAccess.Repositories;
...
namespace Paladyne.DashboardCatalog.DataAccess
{
    ...
    public class RepositoryFactories
    {
        ...
        private IDictionary<Type, Func<DbContext, object>> GetFactories()
        {
            ...
            {
                { typeof(IWidgetsRepository), dbContext => new WidgetsRepository(dbContext) },
                { typeof(IRepository<Dashboard>), dbContext => new DashboardsRepository(dbContext) }
            };
        }
